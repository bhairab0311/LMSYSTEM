...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    let numberofuser = users.filter((user) => user.role === "User");
          ...
          <div className="flex flex-[4] flex-col gap-7 lg:gap-7 lg:py-5 justify-start xl:min-h-[85.5vh]">
            <div className="flex flex-col-reverse lg:flex-row gap-7 flex-[4]">
              <div className="flex flex-col gap-7 flex-1">
                <div className="flex items-center gap-3 bg-white p-5 max-h-[120px] overflow-hidden rounded-lg transition hover:shadow-inner duration-300 w-full lg:max-w-[360px]">
              ...
              <div className="flex flex-col lg:flex-row flex-1">
                <div className="flex flex-col lg:flex-row flex-1 items-center justify-center">
                  <div
                    className="bg-white p-5 rounded-lg  shadow-lg h-full flex flex-col justify-center items-center gap-4
                "
                  >
                    <img
            ...
            <div className="hidden xl:flex bg-white p-7 text-xl sm:text-xl xl:text-3xl 2xl:text-4xl min-h-52 font-semibold relative flex-[3] justify-center items-center rounded-2xl">
               <h4 className="overflow-y-hidden">"Emberking on the journey of reading fosters personal growth,nurturing a path towards excellence and the refinement of character"</h4>
